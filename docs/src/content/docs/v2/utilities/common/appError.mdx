...
<TypeSince type='class' since='0.0.0' />
...
<Parameters parameters={[
  {
    ...
    type: 'ErrorOptions',
    description: [
      () => <>See <a href='#erroroptions'>ErrorOptions</a>.</>,
    ]
  }
]}/>
...
<Parameters parameters={[
  {
    ...
    type: 'ErrorTypes',
    description: [
      () => <>See <a href='#errortypes'>ErrorTypes</a>.</>,
    ]
  },
  {
    name: 'error',
    type: 'string | string[]',
    description: [
      () => <>See <a href='#push'>push</a> `error` parameter for more details.</>,
    ]
  },
  {
    name: 'options',
    type: 'ErrorOptions & { pushOptions?: PushOptions }',
    description: [
      () => <>See <a href='#erroroptions'>ErrorOptions</a> and <a href='#pushoptions'>PushOptions</a>.</>,
    ]
  }
]}/>
...
<Parameters parameters={[
  {
    name: 'aggregateFunc',
    type: '(appError: Omit<AppError<ErrorTypes>, \"end\">) => void | Promise<void>',
    description: [
...
<Parameters parameters={[
  {
    ...
    description: [
      'Called inside a try/catch block to catch errors thrown from other AppError instances.',
      'It can be async or normal function.',
    ]
  }
]}/>
...
<Parameters parameters={[
  ...
  },
  {
    ...
    type: 'PushOptions',
    description: [
      () => <>See <a href='#pushoptions'>PushOptions</a>.</>,
    ]
  }
]}/>
...
<Parameters parameters={[
  {
    name: 'options',
    type: '{ errScope: ErrorScope; includesScope?: ErrorScope; excludesScope?: ErrorScope }',
    description: [
      () => <>
        <DescriptionList list={[
          '`errScope`: the scope of the error to check.',
          '`includesScope`: optional array of scopes to include.',
          '`excludesScope`: optional array of scopes to exclude.',
        ]}/>
      </>,
    ]
  }
...
<Parameters parameters={[
  {
    name: 'options',
    type: "Omit<Parameters<AppError<ErrorTypes>['matchesScope']>[0], 'errScope'>",
    description: [
      'Same as matchesScope options, but without `errScope` (it uses each current error scope).',
    ]
  }
]}/>
