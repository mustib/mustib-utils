...
<Parameters parameters={[
...

  {
    ...
    description: [
      ...
      */
      () => <>
        ...
        <DescriptionList list={[
          ...
          () => <>
            For example, the output might be&nbsp;<code>0y:0mo:0w:0d:0h:2m:0s:5ms</code>
            &nbsp;instead of&nbsp;
            <code>2m:5ms</code>
          </>,
      ...
      */
      () => <>
        <code>options.trimZeroValuedUnits</code>
        <DescriptionList list={[
          () => <Since since='2.10.0'/>,
          () => <>
            A boolean value that indicateswhether to display all time units from minUnit to the last used maxUnit that has no zero values when &nbsp;
            <code>showZeroValuedUnits</code> option set to true
          </>,

          () => <>
            For example, the output might be &nbsp;<code>2m:0s:5ms</code>
            &nbsp; instead of &nbsp;
            <code>0y:0mo:0w:0d:0h:2m:0s:5ms</code>
          </>,

          () => <Default value='false'/>,

          () => <Aside type='note'>
            <code>showZeroValuedUnits</code>
            &nbsp; and &nbsp;
            <code>maxUnits</code> options must be set for this option to take effect
          </Aside>,
        ]}/>
      </>,
      /**
